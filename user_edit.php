        ...
        try {
            ...
            if ($stmt->fetch()) {
                ...
                if ($new_password) {
                    ...
                    $stmt = $pdo->prepare("UPDATE users SET username = :username, password_hash = :password_hash, role = :role, need_password_change = :need_password_change WHERE id = :id");
                    $stmt->execute([
                    ...
                    $stmt = $pdo->prepare("UPDATE users SET username = :username, role = :role, need_password_change = :need_password_change WHERE id = :id");
                    $stmt->execute([
                        ':username' => $new_username,
                        ':role' => $role,
                        ':need_password_change' => $need_password_change,
...
<head>
    ...
    <title>Network Monitor - Edit User</title>
